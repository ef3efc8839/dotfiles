...
static const char *fonts[]          = { "Iosevka:style=Regular:pixelsize=16", "Font Awesome 6 Free Regular:style=Regular:pixelsize=16:antialias=true:" };
static const char dmenufont[]       = "Iosevka:style=Regular:pixelsize=16";
